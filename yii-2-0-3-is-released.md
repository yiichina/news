...
这是内部主要的一个比较大的变化。我们已经取代 Mcrypt （它的作者八年没有碰他了它的作者八年没有碰他了）和 OpenSSL 在 yii\base\Security 中。感谢 Tom Worster 在保持高度安全和标准的 Yii 中所做的出色的工作。由于 OpenSSL 默认情况下内建于 PHP 中，所以你应该不会遇到任何向后兼容的问题。但是如果你这样做，请告诉我们。
